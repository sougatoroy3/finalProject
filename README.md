...
Sell:
Users can sell shares of a stock.History: User can see the past transaction history.
Tech Stack-PythonFlaskSQLAlchemy(Other dependancies can be found out in te requirements.txt file)
